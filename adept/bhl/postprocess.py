...
class BHLPostprocess:  
    ...
    def _detect_taxon_names(self, paragraph: str) -> list[Span]:                              
        ...
        return [ent.text for ent in doc.ents if ent.label_ == 'LIVB' and self._is_well_formed_name(ent.text)]   
    ...
    def _paragraph_is_description(self, paragraph: str) -> bool:
        return self.text_classifier(paragraph)